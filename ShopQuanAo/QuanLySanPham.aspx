    ...
    <div style = "padding:10px;">
        ...
        <asp:DropDownList
            ...
            <asp:ListItem>13</asp:ListItem>
                 ...
                 <td>
         <asp:RadioButtonList ID="rblGioitinh" runat="server" OnSelectedIndexChanged="rblGioitinh_SelectedIndexChanged">
            ...
            <asp:ListItem>Nữ</asp:ListItem>
             ...
             <tr>
                 <td class="style2">
                     <asp:Button ID="btnDuyet" runat="server" onclick="btnDuyet_Click" Text="Tìm kiếm"
                         Width="94px" />
                 </td>
                 <td class="style3">
                     &nbsp;</td>
        ...
        <table>
            ...
            <tr>
             ...
             <tr>
                ...
                <td class="style6">
                     <asp:RadioButtonList ID="rbtngt" runat="server" RepeatColumns="2">
             ...
             <tr>
                ...
                <td class="style6">
                    <asp:TextBox ID="txtHinhAnh" runat="server" Width="175px"></asp:TextBox>
                </td>
                 <td>
