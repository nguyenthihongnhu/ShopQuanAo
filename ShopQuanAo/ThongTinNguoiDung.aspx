...
<div style="width:691px;">
        ...
        <tr>
            <td class="style2">
                         <asp:Label ID="Label1" runat="server" Text="Mật khẩu cũ" ForeColor="#663300"></asp:Label></td>
            <td class="style3">
                <asp:TextBox ID="txtMatKhauCu" runat="server"  Height="26px" Width="161px"
                    TabIndex="1" ForeColor="#663300" ></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style2">
                         <asp:Label ID="Label2" runat="server" Text="Mật khẩu mới" ForeColor="#663300"></asp:Label></td>
            <td class="style3">
                <asp:TextBox ID="txtMatKhauMoi" runat="server"  Height="26px" Width="161px"
                    TabIndex="1" ForeColor="#663300" ></asp:TextBox>
            </td>
        </tr>
            <tr>
            <td class="style2">
                         <asp:Label ID="Label3" runat="server" Text="Xác nhận mật khẩu mới" ForeColor="#663300"></asp:Label></td>
            <td class="style3">
                <asp:TextBox ID="txtXacNhanMatKhauMoi" runat="server"  Height="26px" Width="161px"
                    TabIndex="1" ForeColor="#663300" ></asp:TextBox>
            </td>
        </tr>
        <tr>
