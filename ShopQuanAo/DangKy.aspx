...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width:691px;">
        ...
        <tr>
            ...
            <td class="style4">
                <asp:RegularExpressionValidator ID="txtUserNameAlphaCheck" runat="server"
                    ErrorMessage="Tên đăng nhập chỉ chứa ký tự không dấu và số !"
                    ValidationExpression="^[a-zA-Z0-9]*$"
                    ControlToValidate="txtTendangnhap" ForeColor="Red"></asp:RegularExpressionValidator>
                &nbsp;<br />
        ...
        <tr>
            ...
            <td class="style4">
                <asp:RequiredFieldValidator ID="rfvMatkhau" runat="server"
                    ...
                    ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
                <asp:Label ID="lblNhapMatKhau" runat="server" ForeColor="Red"></asp:Label>
        ...
        <tr>
            ...
            <td class="style4">
                ...
                <asp:RequiredFieldValidator ID="rfvSodienthoai" runat="server"
                    ...
                    ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
                <asp:Label ID="lblSoDienThoai" runat="server" ForeColor="Red"></asp:Label>
            </td>
        </tr>
        <tr>
